...
public class Preview extends RelativeLayout {
    private static String TAG = com.purplefront.brightly.Preview.class.getSimpleName();
            ...
            try {
                ...
                client.newCall(request).enqueue(new Callback() {
                    ...
                    public void onResponse(Response response) throws IOException {
                        ...
                        mListener.onDataReady(com.purplefront.brightly.Preview.this);
                    }
                });
            }
            catch (Exception ex) {
    ...
    public interface PreviewListener {
        public void onDataReady(com.purplefront.brightly.Preview preview);
    }
